...
const ForDevs = () => {
    ...
    return (
        <div className='bg-[#090f07] rounded-t-4xl w-screen flex relative z-[5000] sm:px-10 md:px-8 tracking-wide'>
            <Image
                alt="code"
            ...
            <div className='max-w-6xl mx-auto flex flex-col items-start justify-start pb-8 pt-[3.5rem] sm:py-12 md:py-[5rem] px-9 lg:px-0'>
                ...
                <div className='flex flex-col items-center lg:items-start justify-center mt-8 sm:mt-12 md:mt-[3rem] w-full'>
                    <h1 className='text-xl sm:text-2xl font-serif font-bold text-center lg:text-left'>
                ...
                <div>
                    <h1 className='mt-20 text-xl sm:text-2xl font-serif font-bold text-center lg:text-left'>
                        What You Can <span className='text-primary'>Build</span><br />
                    </h1>
                    <div className='flex flex-col gap-5 max-w-lg mt-6'>
                        <div className='flex gap-3'>

                            <Button
                                size="lg"
                                variant="outline"
                                className="border-primary/40 text-white/90 font-sans tracking-wide hover:border-primary hover:bg-primary/10 hover:text-primary transition"
                    ...
                    <div className='mt-10 flex gap-3 items-center justify-start'>
                        <Button
                            asChild
                            size="lg"
                        ...
                        <Button
                            ...
                            <Link href="https://github.com/zyppprotocol" className='flex gap-2 items-center justify-center'>
                                <Github className='size-7 absolute bottom-[-2]' fill='black' />
                            </Link>
                        </Button>
                    </div>
                </div>
